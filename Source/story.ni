"Daughter of Fortune" by Izzy
[last edited 10/6 2:00]
...
The description of the player is "Your real name's Eliza Sommers, but you're disguised as a boy named Elias Andieta. You've gone by this name while in America to find your lover; Joaquin Andieta. You've travelled with Joe and her Doves for a while as their piano player after meeting them in a town some time ago. Since it's winter now, you've settled down in a Barn to wait it out."

When play begins:
	say "Jack, the Mexican that showed up a couple days ago needs the fingers on his left had to be cut off due to frostbite. He sits in a chair in the barn. You'll need a sharp knife, a hammer, a needle, thread, and clean rags to cut it off."
...
Topic	Reply
"thread/needle"	"Tom No-Tribe says that the Dove Sisters would probably have that type of stuff. They're most likely to need it since they're girls."
"hammer"	"He thinks he's seen Babalu the Bad and Joe Bonecrusher use one sometimes. They'd probably know where to find it."
"clean rags/cloth/rags"	"Tom thinks for a bit and says you could use anything, but the Doves would probably have something like that."
"sharp knife/knife"	"He scoffs and looks at you like you should know where to find that already."
...
Toolbox is scenery in Joe R. Toolbox is an locked and lockable container. "Usually only Joe and Babalu use the toolbox."

Hammer is a thing in toolbox. Hammer is undescribed. "Don't go around hitting everything with the hammer."
...
Instead of Asking Sister A about a topic listed in the Table of Sister A's Replies:
	say "[reply entry]";
	if topic is "clean rags" and player is not carrying clean rags:
...
Topic	Replies
"clean rags/rags"	"My older sister has that."
"thread/needle"	"It should be in here somewhere."
"knife/sharp knife/hammer"	"I don't know."
...
"clean rags/rags"	"I think the older sister was looking for that."
"thread"	"I think we might have some inside our dresser."
"hammer"	"Maybe Babalu or Joe would know where that is."
"knife/sharp knife"	"I'm sure the kitchen will have something like that."
...
Doves Dresser is scenery in Doves R. Doves Dresser is a closed container. The description of Doves Dresser is "A simple, but large dresser."
...
Knife is a thing inside big box. The description of knife is "The knife is really sharp. Don't cut yourself with it." Understand "sharp knife" as knife.
...
Topic	Reply
"knife/sharp knife"	"That's in the kitchen. You of all people should know that, you're the one that cooks most of the time."
"hammer"	"Oh, that's in the toolbox. It's usually locked, but Joe probably has the key for it."
"needle/thread/rags/clean rags/"	"I think the Doves went into their room to look for that."
...
Joe Bonecrusher is a person in barn. The description of Joe Bonecrusher is "Joe's a kind person." Joe Bonecrusher is undescribed.

Instead of talking to Joe Bonecrusher:
	say "Try asking Joe about what you need instead."
...
Topic	Reply
"knife/sharp knife"	"You should know where that is, you're the one that cooks the most for us."
"hammer"	"That's inside of the toolbox."
"toolbox"	"You'll need a key to open it."
"key"	"Here, I have it."
"thread/needle/clean rags/rags"	"Didn't you tell the Doves to look for that? Check with them."
"what you need"	"You said that you needed a knife, a hammer, thread, a needle, and clean rags."
...
Jack is a man. Jack is on chair. The description of Jack is "Jack showed up outside the barn three days ago. To you, he smells of evil and you don't trust him. Now isn't the time to worry about that, his fingers need to be amputated and bandaged." Jack is undescribed.

Jack's fingers are a part of Jack.

Blood is a part of Jack.

Jack's wounds are a part of Jack.
...
Instead of cutting jack's fingers:
	if player is carrying knife and the player is carrying hammer:
		say "You position the knife on the finger  and hit it smartly with the hammer, driving the blade cleanly through the bones and into the wood of the table.";
	if player is not carrying knife and the player is not carrying hammer:
...
Instead of ccutting off jack's fingers:
	say "Try saying cut jack's fingers."
...
Instead of stitching up jack's wounds:
	if player is carrying needle and the player is carrying thread:
		say "Using the needle and thread, you stitch the wounds close.";
...
After stitching up jack's wounds:
	end the story finally saying "You stand back, trying not to vomit at what you had just done. Babalu the Bad, who had kept his distance from the spectacle, walked up timidly, baby's cap in hand, and admiringly murmered, 'You're a real man, Chile Boy.'".
